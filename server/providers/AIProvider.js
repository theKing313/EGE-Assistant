...
${
  isFull
    ? "Реши именно исходное задание кратко: назови правило, покажи ключевые шаги по его условию и в конце укажи один итоговый ответ. Поле example должно содержать только короткий разбор конкретного фрагмента или варианта из исходного задания, а не придуманный похожий пример. Не копируй условие целиком."
